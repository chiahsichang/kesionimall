<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_BlogMessage" Title="空间留言标签" Codebehind="KS.Label.BlogMessage.aspx.cs" %>
...
<script type="text/javascript">
  ...
  function checkform()
  {
   ...
   var str='{KS:Label Type="blogMessagelist"'
          + ' ModelID="' + classid + '"'
          + ' ShowType="'+showType+'"'
...
<KS:TopNav runat="server" Text="创建空间留言标签" ID="TopNav1" />
     ...
     <td class="righttd" style="text-align: left; height: 30px;"><span  id="classidarea" runat="server"></span><font color=red> 请选择标签所属目录，以便日后管理标签</font></td>
        ...
        <tr>
                ...
                <td id="Td3" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                    ...
                    <asp:ListItem Value="ID desc">留言ID降序</asp:ListItem>
                    <asp:ListItem Value="ID asc">留言ID升序</asp:ListItem>
            ...
            <tr>
                ...
                <tr>
                    <td align="center"><div onclick="InsertValue('{KS:Field:BlogMessageUrl}');" class="field" style="cursor:pointer">留言(URL)</div></td>
                    <td align="center"><div onclick=InsertValue('{KS:Field:ID}'); title="留言ID" class="field" style="cursor:pointer">留言文章ID</div></td>
                    <td align="center"><div onmousedown="DragStart()" id="AddDate" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">留言时间</div></td>
                    <td align="center"><div onclick=InsertValue('{KS:Field:Sender}');  class="field" style="cursor:pointer">留言用户</div></td>

                    <td align="center"><div onmousedown="DragStart()" id="Message" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">留言内容</div></td>
                    <td align="center"><div onmousedown="DragStart()" id="Title" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">留言标题</div></td>
