<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_Blog" Title="空间列表标签" Codebehind="KS.Label.Blog.aspx.cs" %>
...
<script type="text/javascript">
  ...
  function checkform()
  {
   ...
   var str='{KS:Label Type="bloglist"'
          + ' ModelID="' + classid + '"'
          + ' ShowType="'+showType+'"'
...
<KS:TopNav runat="server" Text="创建空间列表标签" ID="TopNav1" />
     ...
     <td class="righttd" style="text-align: left; height: 30px;"><span  id="classidarea" runat="server"></span><font color=red> 请选择标签所属目录，以便日后管理标签</font></td>
                  ...
                  <td valign="top" width="280">
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                       ...
                       <td valign="top" style="padding:4px">如果同时要调用多个<br />栏目频道下的链接，可以按键盘<br />的<font color=red>Ctrl</font>键多选。</td>
                      </tr>
                    </table>
                </td>
        ...
        <tr>
                ...
                <td id="Td3" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                    ...
                    <asp:ListItem Value="BlogID desc">空间ID降序</asp:ListItem>
                    <asp:ListItem Value="BlogID asc">空间ID升序</asp:ListItem>
                    <asp:ListItem Value="AddDate desc">更新时间降序</asp:ListItem>
                    <asp:ListItem Value="AddDate asc">更新时间升序</asp:ListItem>
                      </asp:DropDownList>
                    <p style="display:none;">是否输出到博客空间：  <asp:CheckBox runat="server" ID="chkExportBlog" Text="输出到博客空间" /></p>
            ...
            <tr>
                ...
                <td id="Td1" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                        ...
                        <input type="checkbox" runat="server" id="chkHot" value="2" />热门&nbsp;&nbsp;
                </td>
            </tr>
            <tbody id="show1">
            <tr>
            ...
            <tr>
                ...
                <tr>
                <td align="center"><div onclick="InsertValue('{KS:Field:BlogUrl}');" class="field" style="cursor:pointer">空间(URL)</div></td>
                <td align="center"><div onclick=InsertValue('{KS:Field:BlogID}'); title="空间ID" class="field" style="cursor:pointer">空间ID</div></td>
                <td align="center"><div onmousedown="DragStart()" id="BlogName" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">空间标题</div></td>
                ...
                <td align="center"><div onmousedown="DragStart()" id="UserName" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">空间用户</div></td>
                <td align="center"><div onmousedown="DragStart()" id="Descript" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">空间描述</div></td>
                <td align="center"><div onmousedown="DragStart()" id="ClassName" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">空间类别</div></td>
                    <td align="center"><div onclick=InsertValue('{KS:Field:Logo}'); title="空间ID" class="field" style="cursor:pointer">空间图标地址</div></td>
                <td align="center" style="display:none;"><div onclick=InsertValue('{KS:Field:BlogArticleNewIco}'); title="空间New图标" class="field" style="cursor:pointer">New图标</div></td>
                </tr>
