<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_ProBrandList" Title="Untitled Page" Codebehind="KS.Label.ProBrandList.aspx.cs" %>
...
<script type="text/javascript">
  ...
  function checkform()
  {
   ...
   var str='{KS:Label Type="IProBrandList"'
...
<KS:TopNav runat="server" Text="品牌列表标签第一步" ID="TopNav1" />
    ...
    <KS:Foot ID="Foot1" runat="server" OnSubmit="Foot1_Submit" SubmitButtonText="下一步(0)" />
        ...
        <asp:Panel ID="Step2Panel" runat="server" Visible="false" Width="100%">
            ...
            <tr>
                ...
                <td id="Td3" runat="server" class="righttd" colspan="2" 
                    ...
                    条&nbsp; <strong>排序方式：</strong><asp:DropDownList ID="Order" runat="server">
                        <asp:ListItem Value="ID desc">品牌ID降序</asp:ListItem>
                        <asp:ListItem Value="ID asc">品牌ID升序</asp:ListItem>
                        <asp:ListItem Value="orderid desc">品牌序号降序</asp:ListItem>
                        <asp:ListItem Value="orderid asc">品牌序号升序</asp:ListItem>
            ...
            <tr>
                ...
                <tr>
                <td align="center"><div  onclick="InsertValue('{KS:Field:BrandURL}')" class="field" style="cursor:pointer">品牌链接URL</div></td>
                <td align="center"><div  onclick="InsertValue('{KS:Field:BrandID}')" class="field" style="cursor:pointer">品牌ID</div></td>
                <td align="center"><div onmousedown="DragStart()" id="BrandName" fieldtype="1" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">品牌名称</div></td>
                <td align="center"><div onmousedown="DragStart()" id="PhotoUrl" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">品牌图片</div></td>
                <td align="center"><div onmousedown="DragStart()" id="Intro" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">品牌介绍</div></td>
                <td align="center"><div onmousedown="DragStart()" id="firstAlphabet" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">首字母</div></td>
                <tr><td align="center"><div onmousedown="DragStart()" id="Num" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">商品数量</div></td>
                <td align="center"><div onmousedown="DragStart()" id="OrderID" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">排列序号</div></td>
                <td align="center"><div onmousedown="DragStart()" id="BrandEName" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">英文名称</div></td></tr>
                </tr></table>
