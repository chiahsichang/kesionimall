<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_BlogVisitors" Title="空间访客标签" Codebehind="KS.Label.BlogVisitors.aspx.cs" %>
...
<script type="text/javascript">
  ...
  function checkform()
  {
   ...
   var str='{KS:Label Type="blogVisitorslist"'
          + ' ModelID="' + classid + '"'
          + ' ShowType="'+showType+'"'
...
<KS:TopNav runat="server" Text="创建空间访客标签" ID="TopNav1" />
     ...
     <td class="righttd" style="text-align: left; height: 30px;"><span  id="classidarea" runat="server"></span><font color=red> 请选择标签所属目录，以便日后管理标签</font></td>
        ...
        <tr>
                ...
                <td id="Td3" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                    ...
                    <asp:ListItem Value="ID desc">访客ID降序</asp:ListItem>
                    <asp:ListItem Value="ID asc">访客ID升序</asp:ListItem>
            ...
            <tr>
                ...
                <tr>
                <td align="center"><div onclick="InsertValue('{KS:Field:BlogVisitorsUrl}');" class="field" style="cursor:pointer">访客(URL)</div></td>
                <td align="center"><div onclick=InsertValue('{KS:Field:ID}'); title="访客ID" class="field" style="cursor:pointer">访客ID</div></td>
                <td align="center"><div onmousedown="DragStart()" id="AddDate" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">访问时间</div></td>
                <td align="center"><div onclick=InsertValue('{KS:Field:UserName}'); title="访客照片" class="field" style="cursor:pointer">访客用户名</div></td>
                <td align="center"><div onclick=InsertValue('{KS:Field:UserFace}'); title="访客照片" class="field" style="cursor:pointer">访客照片</div></td>
                </tr>
