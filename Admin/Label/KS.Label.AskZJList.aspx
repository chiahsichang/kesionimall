<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_AskZJList" Title="问答专家列表标签" Codebehind="KS.Label.AskZJList.aspx.cs" %>
...
<KS:TopNav runat="server" Text="创建专家列表标签" ID="TopNav1" />
...
<tr>
            ...
            <td class="righttd">
               <table border="0" width="100%" cellpadding="0" cellspacing="0">
                ...
                <asp:ListItem Value="0" Selected>--问答分类不限--</asp:ListItem>
                </asp:ListBox></td>
                ...
                <asp:CheckBoxList ID="Attribute" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        ...
                        <asp:ListItem Value="2">固顶</asp:ListItem>
                    </asp:CheckBoxList>
                    <br />
                <strong>专家分类：</strong><asp:DropDownList ID="DrptypeId" runat="server"><asp:ListItem 
                                Value="0">--不指定专家分类--</asp:ListItem></asp:DropDownList>
                </td>
                 </tr>
                </table>
        ...
        <tr>
                ...
                <td id="Td3" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                    ...
                    <asp:ListItem Value="ZJID desc">专家ID降序</asp:ListItem>
                    <asp:ListItem Value="ZJID asc">专家ID升序</asp:ListItem>
                    <asp:ListItem Value="AskNum desc">咨询量降序</asp:ListItem>
                    <asp:ListItem Value="AskNum asc">咨询量升序</asp:ListItem>
                    <asp:ListItem Value="BestNum desc">解决量降序</asp:ListItem>
                    <asp:ListItem Value="BestNum asc">解决量升序</asp:ListItem>
            ...
            <tr>
                ...
                <tr>
                <td align="center">
                <div  onclick="InsertValue('{KS:Field:UserID}')" class="field" style="cursor:pointer">专家UserID</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:AskZJUrl}');" class="field" style="cursor:pointer">咨询(URL)</div></td>
                <td align="center"><div onmousedown="DragStart()" id="realname" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">专家姓名</div></td>
                <td align="center"><div onmousedown="DragStart()" id="AddDate" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">加入时间</div></td>
                <td align="center"><div onmousedown="DragStart()" id="UserFace" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">照片地址</div></td>
                <td align="center"><div onmousedown="DragStart()" id="UserName" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">用户名</div></td>
                </tr>
                <tr>
                 <td align="center"><div onmousedown="DragStart()" id="Sex" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">性别</div></td>
                 <td align="center"><div onmousedown="DragStart()" id="Address" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">联系地址</div></td>
                 <td align="center"><div onmousedown="DragStart()" id="Tel" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">联系电话</div></td>
                 <td align="center"><div onmousedown="DragStart()" id="QQ" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">联系QQ</div></td>
                 <td align="center"><div onmousedown="DragStart()" id="AskNum" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">咨询量</div></td>
                 <td align="center"><div onmousedown="DragStart()" id="BestNum" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">解决问题量</div></td>
             </tr>
                <tr>
                <td align="center"><div onmousedown="DragStart()" id="Intro" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">专家介绍</div></td>
                <td align="center"><div onmousedown="DragStart()" id="DanWei" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">工作单位</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:AskZJTypeName}')" class="field" style="cursor:pointer">专家分类</div></td>
                 <td align="center"><div onmousedown="DragStart()" id="SCFL" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">擅长分类</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:AskClassName}')" class="field" style="cursor:pointer">所属问吧分类</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:BirthDay}')" class="field" style="cursor:pointer">出生日期</div></td>
                </tr>
               </table>
