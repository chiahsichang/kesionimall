<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_Class" Title="栏目列表标签" Codebehind="KS.Label.Class.aspx.cs" %>
...
<KS:TopNav runat="server" Text="创建栏目导航列表标签" ID="TopNav1" />
        ...
        <tr>
            ...
            <td runat="server" class="righttd"  style="height: 30px; text-align: left">
                <asp:RadioButtonList ID="RdbModelType" runat="server" 
                 ...
                 <asp:ListItem Value="0" Selected>内容模型</asp:ListItem>
                 <asp:ListItem Value="1">网店模型</asp:ListItem>
                ...
                <td runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                 ...
                 <table border="0" cellpadding="0" cellspacing="0">
                     <tr>
                      ...
                      <option value="0">-总站导航-</option>
                      <option value="-1" style="color:red">当前栏目通用</option>
                      <option value="-2" style="color:blue">同级栏目导航</option>
                       <%=classOption%>
                      </select> 
                     </td>
                      <td>
                      <strong>&nbsp;按Ctrl可以多选，多选时， 将直接输出多选的栏目。选择总站导航时将不受模型限制。</strong>

                           <br />&nbsp;<font color=blue>若要调用多个栏目，可以按Ctrl进行多选</font>
					  <br/>
                     <asp:CheckBox ID="CkbSingle" runat="server" Text="仅调用选中的栏目" /><br />
					  <a href="javascript:;" onclick="$('#classid1').height($('#classid1').height()*2);" style="font-weight:bold;color:green;">+增高</a>
</td>
            ...
            <tr>
                ...
                <tr>
                <td align="center">
                <div  onclick="InsertValue('{KS:Field:ClassID}')" class="field" style="cursor:pointer">栏目ID</div></td>
                <td align="center"><div onmousedown="DragStart()" id="ClassID" fieldtype="1" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">栏目ID(URL)</div></td>
                <td align="center"><div onmousedown="DragStart()" id="ClassName" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">栏目名称</div></td>
                <td align="center"><div onmousedown="DragStart()" id="AddDate" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">栏目创建时间</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:ClassImgSrc}')" class="field" style="cursor:pointer">栏目图片地址</div></td>
                </tr>
                <tr>
                <td align="center"><div onclick="InsertValue('{KS:Field:ClassIntro}')" class="field" style="cursor:pointer">栏目介绍</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:ChannelID}')" class="field" style="cursor:pointer">栏目所属模型ID</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:ParentID}')" class="field" style="cursor:pointer">栏目父栏目ID</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:CurrentCss}')" class="field" style="cursor:pointer">当前栏目CSS</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:InfoNum}')" class="field" style="cursor:pointer">栏目下文档数</div></td>
                </tr>
               </table>
