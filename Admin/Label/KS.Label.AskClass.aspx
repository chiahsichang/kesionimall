<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_AskClass" Title="问吧分类列表标签" Codebehind="KS.Label.AskClass.aspx.cs" %>
...
<script type="text/javascript">
  function checkform()
  {
   ...
   var classid='';
   jQuery("#<%=this.DrpClassID.ClientID %> option:selected").each(function() {
   ...
   var str='{KS:Label Type="askclasslist"'
          + ' ClassID="'+classid+'"'
          + ' Ajax="'+ajax+'"'
...
<KS:TopNav runat="server" Text="创建问吧分类导航列表标签" ID="TopNav1" />
     ...
     <td class="righttd" style="text-align: left; height: 30px;"><span  id="classidarea" runat="server"></span><font color=red> 请选择标签所属目录，以便日后管理标签</font></td>
        ...
        <tr>
            ...
            <tr>
                ...
                <td runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                 <table border="0" cellpadding="0" cellspacing="0">
                     <tr>
                      <td>
                      <asp:ListBox ID="DrpClassID" runat="server" Rows="4" SelectionMode="Multiple">
                       <asp:ListItem Value="0">顶级分类导航</asp:ListItem>
                      </asp:ListBox>
                      
                     </td>
                      <td>
                      <strong>&nbsp;按Ctrl可以多选，多选时， 将直接输出多选的分类。</strong></td>
                      <td>&nbsp;
                       </td>
                      <td>&nbsp;</td>
                     </tr>
            ...
            <tr>
                ...
                <tr>
                <td align="center"><div  onclick="InsertValue('{KS:Field:ClassID}')" class="field" style="cursor:pointer">分类ID</div></td>
                <td align="center"><div  onclick="InsertValue('{KS:Field:AskClassURL}')" class="field" style="cursor:pointer">分类URL</div></td>
                ...
                <td align="center"><div onclick="InsertValue('{KS:Field:ClassImgSrc}')" class="field" style="cursor:pointer">分类图片地址</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:ClassIntro}')" class="field" style="cursor:pointer">分类介绍</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:ParentID}')" class="field" style="cursor:pointer">分类父ID</div></td>
                </tr>
               </table>
            ...
            <tr>
                ...
                <td id="Td10" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                    <asp:TextBox ID="LoopBody" onmouseup="dragend()" Height="150px" CssClass="textbox textarea" onmousemove="movePoint()" onclick='setPos()' onkeyup='setPos()' runat="server" Rows="6" TextMode="MultiLine" Width="92%"></asp:TextBox>
