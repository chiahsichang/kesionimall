<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_SJClass" Title="试卷分类列表标签" Codebehind="KS.Label.SJClass.aspx.cs" %>
...
<script type="text/javascript">
  function checkform()
  {
   ...
   var str='{KS:Label Type="sjclasslist"'
          + ' ClassID="'+classid+'"'
          + ' Ajax="'+ajax+'"'
...
<KS:TopNav runat="server" Text="创建试卷分类导航列表标签" ID="TopNav1" />
     ...
     <td class="righttd" style="text-align: left; height: 30px;"><span  id="classidarea" runat="server"></span><font color=red> 请选择标签所属目录，以便日后管理标签</font></td>
        ...
        <tr>
            ...
            <tr>
                ...
                <td align="center"><div  onclick="InsertValue('{KS:Field:SJClassURL}')" class="field" style="cursor:pointer">分类URL</div></td>
