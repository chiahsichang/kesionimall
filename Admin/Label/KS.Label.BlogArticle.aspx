<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_BlogArticle" Title="博文列表标签" Codebehind="KS.Label.BlogArticle.aspx.cs" %>
...
<KS:TopNav runat="server" Text="创建博文列表标签" ID="TopNav1" />
     ...
     <td class="righttd" style="text-align: left; height: 30px;"><span  id="classidarea" runat="server"></span><font color=red> 请选择标签所属目录，以便日后管理标签</font></td>
        ...
        <tr>
                ...
                <td id="Td3" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                    ...
                    <asp:ListItem Value="BlogID desc">博文ID降序</asp:ListItem>
                    <asp:ListItem Value="BlogID asc">博文ID升序</asp:ListItem>
            ...
            <tr>
                ...
                <tr>
                <td align="center"><div onclick="InsertValue('{KS:Field:BlogArticleUrl}');" class="field" style="cursor:pointer">博文(URL)</div></td>
                <td align="center"><div onclick=InsertValue('{KS:Field:ID}'); title="博文ID" class="field" style="cursor:pointer">博文ID</div></td>
                <td align="center"><div onmousedown="DragStart()" id="Title" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">博文标题</div></td>
                ...
                <td align="center"><div onmousedown="DragStart()" id="Author" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">博文作者</div></td>
                <td align="center"><div onmousedown="DragStart()" id="Content" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">博文内容</div></td>
                <td align="center" style="display:none;"><div onclick=InsertValue('{KS:Field:BlogArticleNewIco}'); title="博文New图标" class="field" style="cursor:pointer">New图标</div></td>
                </tr>
