<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_SJReviews" Title="试卷考后心得标签" Codebehind="KS.Label.SJReviews.aspx.cs" %>
...
<script type="text/javascript">
  ...
  function checkform()
  {
   ...
   var str='{KS:Label Type="sjreviewslist"'
          + ' ClassID="' + classid + '"'
...
<KS:TopNav runat="server" Text="创建考后心得列表标签" ID="TopNav1" />
...
<tr>
            ...
            <td class="righttd">
               <table border="0" width="100%" cellpadding="0" cellspacing="0">
                ...
                <asp:ListItem Value="0" Selected>--试卷分类不限--</asp:ListItem>
                </asp:ListBox></td>
        ...
        <tr>
                ...
                <td id="Td3" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                    ...
                    <asp:ListItem Value="a.ID desc">心得ID降序</asp:ListItem>
                    <asp:ListItem Value="a.ID asc">心得ID升序</asp:ListItem>
                    <asp:ListItem Value="CmtNum desc">回复数降序</asp:ListItem>
                    <asp:ListItem Value="CmtNum asc">回复数升序</asp:ListItem>
            ...
            <tr>
                ...
                <tr>
                <td align="center">
                <div  onclick="InsertValue('{KS:Field:ReviewsID}')" class="field" style="cursor:pointer">心得ID</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:SJReviewsUrl}');" class="field" style="cursor:pointer">心得链接(URL)</div></td>
                ...
                <td align="center"><div onmousedown="DragStart()" id="AddDate" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">发表时间</div></td>
                <td align="center"><div onmousedown="DragStart()" id="Content" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">发表内容</div></td>
                </tr>
                <tr> 
                <td align="center"><div onclick="InsertValue('{KS:Field:SJUrl}');" class="field" style="cursor:pointer">试卷链接(URL)</div></td>
                 <td align="center"><div onclick="InsertValue('{KS:Field:UserName}')" class="field" style="cursor:pointer">发表人</div></td>
                 <td align="center"><div onclick="InsertValue('{KS:Field:CMTNum}')" class="field" style="cursor:pointer">回复数</div></td>
                 <td align="center"><div onclick="InsertValue('{KS:Field:UserIP}')" class="field" style="cursor:pointer">用户IP</div></td>
                 <td align="center"><div onclick="InsertValue('{KS:Field:SJID}')" class="field" style="cursor:pointer">试卷ID</div></td>
