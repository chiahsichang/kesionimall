<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_AskList" Title="问答问题列表标签" Codebehind="KS.Label.AskList.aspx.cs" %>
...
<KS:TopNav runat="server" Text="创建问题列表标签" ID="TopNav1" />
...
<tr>
            ...
            <td class="righttd">
               <table border="0" width="100%" cellpadding="0" cellspacing="0">
                ...
                <asp:ListItem Value="0" Selected>--问答分类不限--</asp:ListItem>
                       ...
                       <td valign="top" style="padding:4px">如果同时要调用多个<br />分类下的问题，可以按键盘<br />的<font color=red>Ctrl</font>键多选。</td>
                      </tr>
                    </table>
                </td>
                <td>
                ...
                <asp:CheckBoxList ID="Attribute" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        ...
                        <asp:ListItem Value="3">有悬赏分</asp:ListItem>
                    </asp:CheckBoxList>
                <br />
                <strong>条件：</strong>
                <asp:RadioButtonList ID="RdbCondition" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                  <asp:ListItem Value="0" Selected>不限</asp:ListItem>
                  <asp:ListItem Value="1">仅显示未解决</asp:ListItem>
                  <asp:ListItem Value="2">仅显示已解决</asp:ListItem>
                  <asp:ListItem Value="3">仅显示被关闭</asp:ListItem>
                </asp:RadioButtonList>
                </td>
                 </tr>
                </table>
        ...
        <tr>
                ...
                <td id="Td3" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                    ...
                    <asp:ListItem Value="TopicID desc">问题ID降序</asp:ListItem>
                    <asp:ListItem Value="TopicID asc">问题ID升序</asp:ListItem>
                    <asp:ListItem Value="LastPostTime desc">最后回答时间降序</asp:ListItem>
                    <asp:ListItem Value="LastPostTime asc">最后回答时间升序</asp:ListItem>
                    <asp:ListItem Value="SolveTime desc">最新解决的时间</asp:ListItem>
                      </asp:DropDownList>
            ...
            <tr>
                ...
                <tr>
                <td align="center">
                <div  onclick="InsertValue('{KS:Field:TopicID}')" class="field" style="cursor:pointer">问题ID</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:QuestionUrl}');" class="field" style="cursor:pointer">问题链接(URL)</div></td>
                <td align="center"><div onmousedown="DragStart()" id="Title" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">问题名称</div></td>
                <td align="center"><div onmousedown="DragStart()" id="AddDate" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">提问时间</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:AskClassName}')" class="field" style="cursor:pointer">问题分类名称</div></td>
                </tr>
                <tr>               
                 <td align="center"><div onclick="InsertValue('{KS:Field:AskClassURL}')" class="field" style="cursor:pointer">问题分类URL</div></td>
                 <td align="center"><div onclick="InsertValue('{KS:Field:Reward}')" class="field" style="cursor:pointer">悬赏分</div></td>
                 <td align="center"><div onclick="InsertValue('{KS:Field:Hits}')" class="field" style="cursor:pointer">浏览数</div></td>
                 <td align="center"><div onclick="InsertValue('{KS:Field:RewardIco}')" class="field" style="cursor:pointer">悬赏分（带图标）</div></td>
                 <td align="center"><div onclick="InsertValue('{KS:Field:UserName}')" class="field" style="cursor:pointer">提问者</div></td>

</tr>
                <tr>
                <td align="center"><div onclick="InsertValue('{KS:Field:UserID}')" class="field" style="cursor:pointer">提问者UserID</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:UserIP}')" class="field" style="cursor:pointer">提问IP</div></td>
                <td align="center"><div onclick="InsertValue('{$Field(LastPostTime,date,YY-MM-DD)}')" class="field" style="cursor:pointer">最后回复时间</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:PostNum}')" class="field" style="cursor:pointer">回复数</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:BestUserName}')" class="field" style="cursor:pointer">最佳答案用户</div></td>
                </tr>
               </table>
