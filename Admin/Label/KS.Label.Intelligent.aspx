<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_Intelligent" Title="Untitled Page" CodeBehind="KS.Label.Intelligent.aspx.cs" %>
...
<script type="text/javascript">
  ...
  function checkform()
  {
   ...
   var str='{KS:Label Type="IList"'
          ...
          + ' AutoArea="' + autoarea+'"'
          + ' SpecialID="'+jQuery("#specialid1").val()+'"'
    ...
    <tr>
     ...
     <td class="righttd" style="text-align: left; height: 30px;"><span  id="classidarea" runat="server"></span><span style="color:blue"> 请选择标签所属目录，以便日后管理标签</span></td>
        ...
        <tr>
            ...
            <td class="righttd" style="height: 30px; text-align: left">
                <asp:TextBox ID="Descript" runat="server" Rows="8" TextMode="MultiLine" Width="500px"></asp:TextBox>
                <a href="javascript:zoomtextarea(-5,'<%=this.Descript.ClientID %>');">
            ...
            <tr>
                ...
                <td id="Td4" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                 <table border="0" cellpadding="0" cellspacing="0">
                     <tr>
                      <td style="width: 1px">
                      <select name='classid1' id='classid1' multiple size='3' style='height:120px;width:350px'>
                      <option value='0'>-不指定栏目-</option>
                      <option value='-1' style='color:red'>当前栏目通用</option>
                     <%=MyCache.GetClassOptionList(modelid)%>
                      </select>
                      <br/>
                     <a class="textarea_min" href="javascript:zoomtextarea(-5,'classid1');"></a>
                      <a class="textarea_max" href="javascript:zoomtextarea(5,'classid1');"></a>
                      </td>
                      <td valign="top">
                      <br />
                      <asp:CheckBox ID="ChildClass" runat="server" Checked="true" Text="允许列出子栏目信息(仅对单选有效)" />
                    ...
                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                     <tr>
                      <td style="width: 1px"><select name="specialid1" id="specialid1" style="width: 120px">
