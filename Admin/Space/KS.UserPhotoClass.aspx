<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Title="相册分类管理" Inherits="Kesion.NET.WebSite.Admin_Space_PhotoClass" Codebehind="KS.UserPhotoClass.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <div id="manage_top">
       <ul>
           <li id='p1'><asp:LinkButton ID="addclassbutton" runat="server" OnClick="addclassbutton_Click">添加相册分类</asp:LinkButton></li><div id="go">
    ...
    <KS:ksgv id="List" runat="server" AutoGenerateColumns="False" EmptyDataText="还没有任何相册分类!" PagerType="CustomNumeric" Width="99%" HorizontalAlign="center" GridLines="None" OnRowDataBound="List_RowDataBound" OnRowCommand="List_RowCommand" OnRowCreated="List_RowCreated" >
        <Columns>
            ...
            <asp:BoundField HeaderText="排序" DataField="orderid" >
             ...
             <asp:TemplateField HeaderText="编辑">
                  ...
                  <itemtemplate>
             <asp:LinkButton ID="LinkButton1" CssClass="edit" ToolTip="编辑" runat="server" commandargument=<%#Eval("classid") %> commandname="modify"></asp:LinkButton>
                 </itemtemplate>
              </asp:TemplateField>
...
<asp:Panel ID="Panel1" runat="server" Height="30px" Width="741px">
    ...
    <asp:Panel ID="AddPanel" runat="server" Width="100%" Visible="false">
        <KS:TopNav ID="TopNav1" runat="server" Text="相册分类" />
        <script type="text/javascript">
            function CheckForm1() 
            {
	         if (jQuery("#<%=this.txtBlogClass.ClientID %>").val()==''){
	           KesionJS.Alert('请填写相册分类名称!','jQuery("#<%=this.txtBlogClass.ClientID %>").focus()');
	           return false
	         }
    ...
    <table width="99%" align="center" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
          <tr>
            <td class="lefttd" height="30" align="right" style="width: 150px"><b>相册分类名称：</b></td>
            <td class="righttd">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtBlogClass"
                    ErrorMessage="请填写相册分类!"></asp:RequiredFieldValidator></td>
          </tr>
        <tr>
            <br />
