<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin.Content.ShowBox" Codebehind="ShowBox.aspx.cs" %>
               ...
               <%
                        ...
                        switch (statusCode)
                        {
                            case 3: //发货信息
                                ...
                                {
                                    dsb.Append(@"<img src=""../../admin/images/dot.gif"" /><strong><font color=""#ff6600"">该订单已发货，发货信息如下：</font></strong><br/>");
                                   ...
                                   %> <asp:Repeater ID="Repeater1" runat="server" >
                                          <HeaderTemplate>
                                           ...
                                           <tr class="tdbg">
                                              ...
                                              <td class="Ctd" align="center"><%# Eval("orderid") %></td>
                                              <td class="Ctd">
                                              <%# Eval("mobile") %>
                                              </td>
                                              <td class="Ctd" align="center"><%# Eval("username") %></td>
                                              <td class="Ctd" align="center"><%# Eval("times") %>次
                                              </td>
