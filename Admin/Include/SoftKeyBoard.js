...
function setVariables() {
	tablewidth=720;  // logo width, in pixels
...
function showkeyboard() {
	...
	if(event.y+840)
	softkeyboard.style.top=event.y+document.body.scrollTop+65;
	if ((event.x-80)>0) {
		softkeyboard.style.left=event.x-80;
	} else {
...
function setCalcButtonBg() {
	alert(jQuery("#softkeyboard").find("input[type=button]").length);
	
	jQuery("#softkeyboard").find("input[type=button]").click(function(){
